...
namespace Microsoft.Scripting.JavaScript
{
    public sealed class JavaScriptRuntimeSettings
    {
        ...
        private bool used_;
        private bool disableFatalOnOOM_;
        ...
        {
            get { return disableFatalOnOOM_; }
            set
            {
                if (used_)
                    throw new InvalidOperationException(Errors.NoMutateJsRuntimeSettings);

                disableFatalOnOOM_ = value;
            }
        }
        ...
        internal JsRuntimeAttributes GetRuntimeAttributes()
        {
            ...
            if (disableFatalOnOOM_)
                result |= JsRuntimeAttributes.DisableFatalOnOOM;

            result |= JsRuntimeAttributes.EnableExperimentalFeatures;
